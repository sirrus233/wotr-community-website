...
export class InfrastructureStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const databaseBackupBucket = new s3.Bucket(this, "DatabaseBackupBucket");
  ...
  website() {
    ...
    const distribution = new cloudfront.Distribution(this, "Distribution", {
      ...
      domainNames: ["*.waroftheringcommunity.net", "waroftheringcommunity.net"],
    });
  ...
  server(elasticIp: ec2.CfnEIP, writeableBuckets: s3.Bucket[]) {
    ...
    const instance = new ec2.Instance(this, "ServerInstance", {
      ...
      vpc,
      role,
      keyPair: ec2.KeyPair.fromKeyPairName(this, "ServerKey", "ServerKey"),
    });
