...
export BIN_PATH="${BUILD_DIR}/build/x86_64-linux/ghc-9.12.2/${PROJECT_NAME}-0.1.0.0/x/${BIN_NAME}/build/${BIN_NAME}/${BIN_NAME}"
...
export DB_BACKUP_BUCKET="infrastructurestack-databasebackupbucket98c63f1e-hhautzgwrbkh"
